...
public class AttendanceController {
	...
	@GetMapping("/get-attendance-by-date-subject/{date}/{subjectId}")
	...
	public StudentAttendanceGroupedDto getAttendanceByStudentAndSubject(@PathVariable long studentId,
